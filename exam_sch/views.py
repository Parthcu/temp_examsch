...
from .models import user_table,roles,Dept,Session,Programme_Level,gender,Program,Subject,Semester,Slot
from .serializers import UserTableSerializer, LoginSerializer,DeptSerializer,SessionSerializer,Program_LevelSerializer
from .serializers import RolesSerializer,GenderSerializer,ProgramSerializer,SubjectSerializer,SemesterSerializer,SlotSerializer
